...
export function LinkedListNode({ data }: NodeProps) {
  return (
    <div className="relative w-full h-full">
      <div className="rounded bg-purple-800 shadow-xl w-full h-full min-w-[200px] min-h-[100px] flex items-center justify-center overflow-hidden">
